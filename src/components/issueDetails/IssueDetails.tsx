  ...
  return (
    <div className="pt-20 max-w-4xl mx-auto space-y-6">
      ...
      <div className="bg-white rounded-lg border border-gray-200 shadow-sm">
        <div className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <div>
                <h3 className="text-sm font-medium text-gray-500 tracking-wide">Assignee</h3>
                <p className="mt-1 text-lg text-gray-900">{issue.assignee}</p>
              </div>
              <div>
                <h3 className="text-sm font-medium text-gray-500 tracking-wide">Created</h3>
            ...
            <div className="space-y-4">
              <div>
                <h3 className="text-sm font-medium text-gray-500 tracking-wide">Priority Details</h3>
          ...
          {issue.tags.length > 0 && (
            <div>
              <h3 className="text-sm font-medium text-gray-500 tracking-wide mb-2">Tags</h3>
      ...
      <div className="bg-gray-50 rounded-lg p-4">
        <h3 className="text-sm font-medium text-gray-500 tracking-wide mb-3">Actions</h3>
