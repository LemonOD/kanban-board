...
const RoleInformation: React.FC<RoleInformationProps> = ({ user }) => (
    <div className="rounded-lg border p-6 bg-white border-gray-200 shadow-sm dark:bg-gray-900 dark:border-gray-700 dark:shadow-none">
        ...
        <div className="space-y-4">
                    ...
                    <ul className="space-y-2 text-sm">
                        {adminPermissions.map((perm) => (
                            <li key={perm} className="flex items-center space-x-2">
                                ...
                                <span className="dark:text-gray-100">{perm}</span>
                            </li>
                        ))}
                    </ul>
                </div>
            ...
            {user.role === "contributor" && (
                <div className="mt-4 p-4 rounded-lg border bg-blue-50 border-blue-200 dark:bg-blue-950 dark:border-blue-900">
                    <div className="flex items-start space-x-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm mt-1 text-blue-700 dark:text-blue-300">
                                You have contributor access, which means you can view and search
                                issues but cannot modify them. Contact an administrator if you
